<?php return array (
  ...
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `resource_type` enum(\'folder\',\'image\',\'map\',\'video\') NOT NULL,
  ...
  PRIMARY KEY (`id`)
	...
	'{prefix}rs_maps' => 'CREATE TABLE `{prefix}rs_maps` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `folder_id` int(11) NOT NULL,
  `attachment_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`)
	...
	'{prefix}rs_membership_presets' => 'CREATE TABLE `{prefix}rs_membership_presets` (
