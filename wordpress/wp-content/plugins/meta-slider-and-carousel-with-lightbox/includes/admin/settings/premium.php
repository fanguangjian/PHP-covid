	...
	<table class="wpos-plugin-pricing-table">
	    ...
	    <thead>
	    	<tr>
	    		...
	    		<th>
	    			<h2>Premium</h2>
	    			<p>Gain access to <strong>Meta slider and carousel with lightbox</strong> included in <br /><strong>Essential Plugin Bundle</p>
	    ...
	    <tfoot>
	    	<tr>
	    		<th></th>
	    		<td></td>
	    		<td><p>Gain access to <strong>Meta slider and carousel with lightbox</strong> included in <br /><strong>Essential Plugin Bundle</p>
