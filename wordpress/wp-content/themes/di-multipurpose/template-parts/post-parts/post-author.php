<div class="post-about-author"> 
	...
	<h3 class="post-about-headline"><?php esc_html_e( 'About author:-', 'di-multipurpose' ) ?></h3>
	...
	if( get_avatar( get_the_author_meta( 'ID' ) ) ) {
		...
		<div class="post-author-avatar">
			<?php
			echo wp_kses_post( get_avatar( get_the_author_meta( 'ID' ), $size = 96, $default = '', $alt = '', array( 'class' => 'img-circle' ) ) );
			?>
		</div>
		<?php
	}
