...
if( ! function_exists( 'di_multipurpose_pr_handle' ) ) {
	/**
	 * Refresh and postMeaage / partial refresh handle.
	 * @param  [type] $wp_customize [description]
	 * @return [type]               [description]
	 */
	function di_multipurpose_pr_handle( $wp_customize ) {
...
add_action( 'customize_register', 'di_multipurpose_pr_handle', 9999999 );
